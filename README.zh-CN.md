...
<!-- prices:start -->
_Snapshot date: **2026-09-06**. 3642 price records across 5 providers. **Reference column** is OpenRouter (officially-authorized, ~5% markup). Rows sorted cheapest-by-OpenRouter first. ⚠ = relay quotes <50% of OpenRouter — verify with [canary prompts](docs/canary-prompts.md) before trusting._
...
| Model | OpenRouter (ref) | Atlas Cloud | Relaydance | UiUiAPI | bltcy |
|---|---|---|---|---|---|
| `gemini-3-flash` | $1.500 | $1.500 | — | $0.500 ⚠ | — |
